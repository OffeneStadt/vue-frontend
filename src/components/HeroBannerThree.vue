                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-7 col-md-7 order-2 order-md-2">
                        <div class="slider-content slider-content__style-3">
                            <h2 class="slider-title"  style="background-color: rgb(31, 68, 108,0.8); padding: 15px; font-size:1.7em">Forum Offene Stadt. Partizipativ, digital, nachhaltig</h2>
                            <p class="slider-desc"  style="background-color: rgb(31, 68, 108,0.8); padding: 15px; font-size:0.9em">
                                ...
                                <br /><br />
                                Mit dem Untertitel partizipativ, digital, nachhaltig richtet sich der thematische Fokus in diesem Jahr auf die Gestaltung der digitalen Stadt der Zukunft. Was braucht es dafür, wie können Bürgerinnen und Bürger beteiligt werden, bei wem finden die Städte Unterstützung und wie kann die Digitalisierung den Verwaltungen dabei helfen, mit Herausforderungen wie der Corona- und Klimakrise umzugehen?
                                <br /><br />
                                ...
                                <br /><br />
                                Um an Diskussionen und Workshops teilzunehmen, melden Sie sich bitte an.
                            </p>
