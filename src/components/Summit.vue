<template>
    <section class="features-area section-padding pt-100 fix" id="summit">
        <div class="container">
            <div class="row">
                <div class="col-12">
...
export default {
    ...
    data () {
        return {
            image: require("../assets/img/summit.png")
        }
    }
}
</script>
