<template>
    <section class="testimonial-area testimonial-style-2 section-padding fix" id="review" :style="bgImg">
        <div class="container">
            <div class="row">
                <div class="col-12">
...
export default {
    ...
    data (){
        return {
            ...
            clients: [
                {clientThumb: require("../assets/img/testimonial/1.png"), name: "MOHAMET LUIS", designation: "Web Designer", desc: "Claritas est etiam processus dynamicus, qui sequitur mutationem consuetudium lectorum. Mirum est notare quam littera gothica, quam nunc putamus parum claram, anteposuerit litterarum formas humanitatis per seacula quarta decima et quinta decima."},
                {clientThumb: require("../assets/img/testimonial/2.png"), name: "ERIN MAYA", designation: "Web Developer", desc: "Claritas est etiam processus dynamicus, qui sequitur mutationem consuetudium lectorum. Mirum est notare quam littera gothica, quam nunc putamus parum claram, anteposuerit litterarum formas humanitatis per seacula quarta decima et quinta decima."},
                {clientThumb: require("../assets/img/testimonial/3.png"), name: "KUNJO PANDE", designation: "Marketer", desc: "Claritas est etiam processus dynamicus, qui sequitur mutationem consuetudium lectorum. Mirum est notare quam littera gothica, quam nunc putamus parum claram, anteposuerit litterarum formas humanitatis per seacula quarta decima et quinta decima."},
            ]
        }
    }
}
